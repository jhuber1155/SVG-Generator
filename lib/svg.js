...
class SVG {
    ...
    setShape(setShape, setColor) {
        ...
        // }
        if(setShape === "circle"){
            this.circle.render(`<circle cx="150" cy="100" r="80" fill= ${setColor} />`)
        }else if(setShape === "triangle"){
            this.triangle.render(`<polygon points="150, 18 244, 182 56, 182" fill= ${setColor}/>`)
        }else if(setShape === "square"){
            this.square.render(`<rect x="90" y="40" width="120" height="120" fill= ${setColor}/>`)
        }
    }
